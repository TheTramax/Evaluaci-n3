...
if (id_cliente === "") {
  mostrarAlertaDeDatos("Por favor, ingrese el nombre de cliente.", "alert-danger");
  return; 
}
if (id_tipo_gestion === "") {
  mostrarAlertaDeDatos("Por favor, ingrese el nombre de tipo gestón.", "alert-danger");
  return; 
}
if (id_resultado === "") {
  mostrarAlertaDeDatos("Por favor, ingrese el nombre de resultado.", "alert-danger");
  return; 
}
if (comentarios === "") {
  mostrarAlertaDeDatos("Por favor, ingrese comentario.", "alert-danger");
  return; 
}
